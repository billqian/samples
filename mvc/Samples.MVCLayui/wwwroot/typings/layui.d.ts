...
declare module layui {
  ...
  interface Layui {
    ...
    router(): any;
      ...
      search: any;
      route(): any;
      define(modules: string[], exports): void;
      
      sessionData(tableName: string, data: any): void;
    //-----------------------end added by bill
  }
    ...
    export let define: (modules?: string[], exports: any) => void;
    
    export let setter: any;
    export let sessionData: (tableName: string, data: any) => void;
